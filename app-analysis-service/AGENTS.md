...
Notas para app-analysis-service:

- Este servicio debe recibir reseñas ya registradas o eventos derivados del Review Service.
- Su responsabilidad es generar analisis por reseña, por sucursal o por negocio usando Gemini.
- No debe encargarse de autenticacion ni de gestionar miembros, sucursales o permisos.
- Los resultados deben quedar asociados siempre a `businessId` y, cuando aplique, a `branchId`.
