...
- Este servicio no debe encargarse del analisis de reseñas ni de reportes.
- Su responsabilidad principal es identidad, sesion, autorizacion y contexto de acceso del usuario.
- Aqui debe quedar definido a que negocio pertenece cada usuario y a que sucursales puede acceder.
