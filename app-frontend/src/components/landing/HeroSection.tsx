...
export default function HeroSection() {
  ...
  return (
    <motion.div className={styles.heroText} {...getReveal(0)}>
      <motion.div className={styles.heroBadge} {...getReveal(0)}>
        <span className={styles.heroBadgeIcon}>✦</span>
        Review Intelligence para tu negocio
      </motion.div>

      <motion.h1 className={styles.heroTitle} {...getReveal(1)}>
        Tus reseñas, leídas por IA y convertidas en{" "}
        <span className={styles.heroTitleHandwritten}>mejoras reales.</span>
      </motion.h1>

      <motion.p className={styles.heroSubtitle} {...getReveal(2)}>
      ...
      <motion.div className={styles.heroActions} {...getReveal(3)}>
      ...
      <motion.div className={styles.heroChecks} {...getReveal(4)}>
