...
Notas para app-report-service:

- Este servicio debe construir reportes a partir de datos ya consolidados de reseñas, analisis y encuestas cuando corresponda.
- Debe operar siempre en el contexto de un negocio y opcionalmente una sucursal.
- No debe encargarse de autenticacion ni de sincronizar reseñas directamente desde Google.
- Puede generar salidas ejecutivas, resumentes por periodo, comparativas y exportaciones.
