...
Notas para app-review-service:

- Este servicio es responsable de la ingesta, normalizacion, deduplicacion y consulta de reseñas externas.
- Debe mapear cada reseña a un `businessId` y a un `branchId` cuando la plataforma de origen entregue esa relacion.
- Debe mantener separada la captura de reseñas publicas del feedback interno de encuestas.
- No debe encargarse de autenticacion ni del analisis semantico profundo, excepto disparar el flujo hacia Analysis Service cuando corresponda.
