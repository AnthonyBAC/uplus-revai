...
Notas para app-surveys-service:

- Este servicio es responsable de definir encuestas, preguntas, sesiones y respuestas capturadas dentro del local.
- Debe soportar uso desde tablet o dispositivos compartidos por el personal del negocio.
- Las respuestas deben quedar vinculadas a `businessId` y opcionalmente a `branchId`.
- No debe mezclarse conceptualmente con las reseñas publicas obtenidas desde plataformas externas.
